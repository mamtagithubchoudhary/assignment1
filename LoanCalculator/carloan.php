      ...
      <div class="top">
        ...
        <form action="carloan.php" method="POST">
          <div class="group">
            ...
            <input type="text" value="400000" name="loanamount"  class="loan-amount" />
          </div>

          <div class="group">
            <div class="title">Interest Rate</div>
            <input type="text" value="8.5" name="interestrate" class="interest-rate" />
          </div>

          <div class="group">
            <div class="title">Tenure (in months)</div>
            <input type="text" value="5" name="loantenure" class="loan-tenure" />
          </div>
        </form>
      </div>
