  ...
  <a href="http://localhost/LoanCalculator/personalloan.php">Personal Loan</a>
    ...
    <div class="loan-calculator">
      <div class="top">
        ...
        <form action="homeloan.php" method="POST">
          <div class="group">
            <div class="title">Amount</div>
            <input type="text" value="5000000" name="loanamount" class="loan-amount" />
          </div>

          <div class="group">
            <div class="title">Interest Rate</div>
            <input type="text" value="7.5" name="interestrate" class="interest-rate" />
          </div>

          <div class="group">
            <div class="title">Tenure (in months)</div>
            <input type="text" value="20" name="loantenure" class="loan-tenure" />
          </div>
        </form>
      </div>
